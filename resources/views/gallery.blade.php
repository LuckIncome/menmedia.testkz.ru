            ...
            <div class="gallery-content">
                    ...
                    <div class="gallery__items">
                        ...
                        <div class="gallery__item">
                            <div class="item__image">
                                <img src="{{Storage::disk('public')->url($photo->image)}}" alt="photo">
                            </div>
                            <div class="item__text">
                                <div class="item__title">
                                    <a href="/photos/{{$photo->id}}">{!!\Illuminate\Support\Str::limit($photo->title,40) !!}</a>
                                </div>
                ...
                <div class="gallery__videos">
                    ...
                    <div class="gallery__items">
                        ...
                        <div class="gallery__item">
                            <div class="item__image">
                                <img src="{{Storage::disk('public')->url($video->image)}}" alt="video">
                            </div>
                            <div class="item__text">
                                <div class="item__title">
                                    <a href="/videos/{{$video->id}}">{!!\Illuminate\Support\Str::limit($video->title,40) !!}</a>
                                </div>
